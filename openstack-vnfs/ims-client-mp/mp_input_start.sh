...
#sipp -sf $imsconf/uas_b2a.xml $pcscf:$remote_sip_port -i $own_ip_addr -p $local_port -m 1000
sipp -sf $imsconf/uas_b2a.xml $pcscf:$remote_sip_port -i $own_ip_addr -p $local_port -m 5000000 -f 15 -trace_stat -fd 5
